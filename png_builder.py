...
def generate_varying_matrices(size_amount, sample_amount=1000, size_range=(100, 501)):
    ...
    for i in range(size_amount):
        print(f"size amount: {size_amount}")
        ...
        print(f"acceptable blocks for this size: {acceptable_blocks}")
        ...
        for block in acceptable_blocks:
            ...
            for j in range(block_samples):
                ...
                #print("*" * 60)
        folder_name = "png_dataset500_testing"
...
generate_varying_matrices(1, sample_amount=3000, size_range=(500,501))
